...
class CustomerRepository {
  ...
  async AddWishlistItem(
    customerId,
    { _id, name, desc, price, avilable, banner }
  ) {
    // referans yönetiminde embeddinge geçtiğimiz için yapılan güncelleme
    const product = { _id, name, desc, price, avilable, banner };
